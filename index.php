...
if (isset($_SESSION['email'])) {
    echo '<div class="filter" style="display: block;">
        <form action="results/" method="get" class="form-group">
            <input type="text" name="overall_grade" class="form-control" placeholder="Enter your overall grade..." required>
            <input type="text" name="language_grade" class="form-control" placeholder="Enter the highest language(English/Kiswahili) subject grade you got..." required>
            <input type="text" name="physics_grade" class="form-control" placeholder="Enter physics grade..." required>
            <input type="text" name="bio/chem_grade" class="form-control" placeholder="Enter biology/chemistry grade..." required>
            <input type="text" name="maths_grade" class="form-control" placeholder="Enter mathematics grade..." required>
            <select name="university" id="" class="form-control" required>
                <option value="0">--select preferred university--</option>

...
if ($university != 0) {
    if ($university == 'all') {
        $SELECT = "SELECT * FROM courses WHERE (minimum_grade = '$overall' OR minimum_grade = '') AND (language_grade_required = '$language' OR language_grade_required = '') AND (bio_chem_grade_required = '$bio_chem' OR bio_chem_grade_required = '') AND (physics_grade_required = '$physics' OR physics_grade_required = '') AND (mathematics_grade_required = '$maths' OR mathematics_grade_required = '') ORDER BY university";
...
?>
            <tr>
                <form action="details.php" method="post">
                    ...
                    <td><?php echo $details1['course_name']; ?></td>
                    <td><?php echo $details1['university']; ?></td>
                    <td><?php echo $details1['minimum_grade']; ?><button type="submit" class="btn btn-info">See more</button></td>
                </form>
            </tr>
            <?php
            }
...
?>
    ...
    <div class="login modal-body">
        <form action="../login.php" method="post" class="form-group">
            ...
            <input type="text" name="email" class="form-control" placeholder="Enter your email/index number..." required>
    ...
    <div class="signup modal-body">
        <form action="../register.php" method="post" class="form-group">
            ...
            <input type="text" name="email" class="form-control" placeholder="Enter a valid email//index number..." required>
